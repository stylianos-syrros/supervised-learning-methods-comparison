...
knn_custom = KNN_Custom(k=5, distance_fn=custom_distance)
...
# Extract F1 scores and accuracy scores
f1_scores = cross_val_score(knn_custom, X, Y, cv=10, scoring='f1_macro')
accuracy_scores = cross_val_score(knn_custom, X, Y, cv=10, scoring='accuracy')
