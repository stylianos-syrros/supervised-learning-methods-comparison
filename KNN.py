...
num=int(input("Please give number of neighbors: "))
model= KNeighborsClassifier(n_neighbors=num) ##by default euclidean distance is used.
model.fit(xTrain,yTrain)
yTest= model.predict(xTest)
createOutput(yTest,"KNN_output.csv")
